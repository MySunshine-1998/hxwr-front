<template>
    <div class="header">
        ...
        <div class="tab">
            <div class="bg textStyle knowledge" @click="PageFunStore.setPageknowledgeBaseClose(true)">
                <RouterLink to="/knowledgeBase/index">知识库</RouterLink>
            </div>
        ...
        <div class="combatSide">
            <div class="bg textStyle" @click="PageFunStore.setPageClose(true)">
                <RouterLink to="/dataManagement/healthForce">信息管理</RouterLink>
            </div>
            <div class="user bgSmall">
...
<script setup>
import { usePageFunStore } from '@/store/modules/pageFun'
import { RouterLink } from 'vue-router'
let PageFunStore = usePageFunStore()
function showPageFun(key) {
    return
}
</script>
...
.header {
    ...
    .bgSmall,
    .bg {
        background-image: url("@/assets/image/bgSmall.png");
        background-size: 100% 100%;
        background-repeat: no-repeat;
        width: 34px;
        height: 34px;
